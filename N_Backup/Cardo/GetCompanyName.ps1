...
foreach($User in $Users){
    ...
    # Get Company 
        ...
        $companyName = Get-ADUser $SamAccountName -Properties Company | Select-Object -ExpandProperty Company
        Write-Host "Result: The comapany name for $($User.'User principal name') is $($companyName)"
        }
}
